...
<table border="1" cellpadding="10" cellspacing="0" style="width: 100%; border-collapse: collapse; font-family: Segoe UI, Arial, sans-serif; font-size: 13px; border: 1px solid #000;">
  <thead>
    ...
    <tr style="background-color: #e6e6e6; text-align: center;">
      ...
      <th style="border: 1px solid #000;"><strong>Smart Stay</strong><br><img src="assets/images/cap2/logo.png" alt="Smart Stay" width="100"></th>
      <th style="border: 1px solid #000;"><strong>Oracle Hospitality</strong><br><img src="assets/images/cap2/oracle-hospitality.png" alt="Oracle" width="100"></th>
      <th style="border: 1px solid #000;"><strong>Room Raccoon</strong><br><img src="assets/images/cap2/logo-roomraccoon.jpeg" alt="Room Raccoon" width="100"></th>
      <th style="border: 1px solid #000;"><strong>Sistemas Manuales</strong><br><img src="assets/images/cap2/Sistemas-Manuales.jpg" alt="Sistemas Manuales" width="100"></th>
    </tr>
  </thead>
  <tbody>
...
* **Entrevista – Segmento 1: Administradores de Hoteles Boutique y Pequeños**
    ...
    * **Entrevista 1:**
        ...
        * **Evidencia:**
          ...
          <img src="assets/images/cap2/adrian_entrevistado.jpg" alt="cap2" style="height: 150px !important; width: 150px !important;">
...
Aunque cuentan con un sistema propio, han tenido problemas de sobreventa porque no se sincroniza con todas las plataformas, lo que obliga a actualizaciones manuales y genera errores. Adrián estaría motivado a usar una herramienta que centralice la gestión y se integre con plataformas externas, siempre que el costo de suscripción sea razonable.
    ...
    * **Entrevista 2:**
        ...
        * **Evidencia:**
          ...
          <img src="assets/images/cap2/monica_entrevistada.jpg" alt="cap2" style="height: 150px !important; width: 150px !important;">
...
Ha tenido dificultades con el uso del sistema actual y señala que le motivaría adoptar una herramienta digital que centralice la gestión de reservas y operaciones, siempre que pueda adaptarse a las características de su hotel. Considera razonable pagar una suscripción mensual si contribuye a mejorar los servicios del establecimiento.
   ...
   * **Entrevista 3:**
        ...
        * **Evidencia:**
          ...
          <img src="assets/images/cap2/alejandra_entrevistada.jpg" alt="cap2" style="height: 150px !important; width: 150px !important;">
...
* **Entrevista – Segmento 2: Huéspedes de Hoteles Boutique**
     ...
     * **Entrevista 1:**
        ...
        * **Evidencia:**
          ...
          <img src="assets/images/cap2/entrevista_alexander.png" alt="cap2" style="height: 150px !important; width: 150px !important;">
...
Considera que el trato humano sigue siendo un valor agregado, aunque la digitalización es clave. Recomienda que los sistemas sean fáciles de usar y que cada hotel cuente con una página clara con descripción completa y disponibilidad de habitaciones en tiempo real.
    ...
    * **Entrevista 2:**
        ...
        * **Evidencia:**
          ...
          <img src="assets/images/cap2/JuanSalcedo.png" alt="cap2" style="height: 150px !important; width: 150px !important;">
...
Juan viaja por trabajo cada 1-2 meses y prefiere alojamientos cómodos, autónomos y con buena conectividad, optando principalmente por Airbnb y, en menor medida, por hoteles. Valora especialmente la ubicación céntrica, el Wi-Fi de calidad y la facilidad tecnológica. Considera que los horarios estrictos de check-in y check-out son una gran limitación, y aunque nunca ha usado una habitación totalmente “smart”, le interesa la idea, aunque cree que aún no está bien implementada en Perú. No pagaría más por funciones digitales avanzadas, ya que las asocia con un público más joven. Usa Wi-Fi como servicio indispensable, junto con laptop y smartphone, y ha tenido experiencias negativas relacionadas con demoras en la atención y falta de limpieza, además de percibir una falta de personalización en el servicio. Recomienda priorizar la mejora del Wi-Fi (fibra óptica) y mantener una atención eficiente, considerando que la digitalización debe complementar, pero no reemplazar, el buen trato humano.
    ...
    * **Entrevista 3:**
        ...
        * **Evidencia:**
          ...
          <img src="assets/images/cap2/EntrevistaTadeoLoja.png" alt="cap2" style="height: 150px !important; width: 150px !important;">
...
![Perfil de edad de administradores — boxplot](assets/images/cap2/S1_01_perfil_edad_boxplot.png)
...
![Concentración geográfica: 100% en Tarapoto](assets/images/cap2/S1_02_concentracion_tarapoto.png)
...
![Tamaño de hoteles (habitaciones) y equipo (empleados)](assets/images/cap2/S1_03_tamano_hoteles_equipo_boxplots.png)
...
![Nivel de digitalización de herramientas actuales](assets/images/cap2/S1_04_nivel_digitalizacion.png)
...
![Distribución de problemas](assets/images/cap2/S1_05_distribucion_problemas.png)
...
![Actitud hacia nueva tecnología](assets/images/cap2/S1_06_actitud_nuevas_tecnologias.png)
...
![Composición generacional de huéspedes](assets/images/cap2/S2_07a_boxplot_edades_huespedes.png)
...
![Propósito de viaje](assets/images/cap2/S2_08a_proposito_viaje.png)
...
![Puntos de dolor](assets/images/cap2/S2_09_puntos_dolor.png)
...
![S2_10_receptividad_digitalizacion.png](assets/images/cap2/S2_10_receptividad_digitalizacion.png)
...
![S2_11_disposicion_pagar.png](assets/images/cap2/S2_11_disposicion_pagar.png)
...
![S2_12_influencia_resenas.png](assets/images/cap2/S2_12_influencia_resenas.png)
